...
class MobileDevice {
    ...
    public boolean rentDevice(String rentDate, String dueDate, Lab lab)
        ...
        if(getRs() != null && getRs().borrowed)
            if(rentDate.equals(rs.rentDate) && dueDate.equals(rs.dueDate))
                return false;
     ...
     *
     * @param lab The lab object index
     * @return return the date when this device is unavailable
     */
    public String unavailableDate(Lab lab) {
        this.lab = lab;
        return Helper.printUnavailable(this, rs.rentDate);
    }
